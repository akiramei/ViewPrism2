...
接続先 E-BOM(既存・厚い): E-UI-BROWSE-022(グリッド/リスト)・E-UI-AXIS-NAV-040(FS/タグビュー軸)・E-UI-MODE-041(タグ編集/整理/メンテ文脈)・E-UI-TAGASSIGN-029(タグ付与パネル)・E-UI-NODEGRAPH-025(タグタブ側ビュー階層エディタ)・E-UI-SHELL-021(コレクション選択)・E-UI-TAGS-026/E-DOMAIN-001(タグ定義消費)・E-DESIGN-028/K-DESIGN(共有材料)。旧 E-UI-GRID-022 は ECO-016 で BROWSE/AXIS/MODE へ分割。
...
2. 承認後、E-UI-NODEGRAPH-025 / E-UI-TAGASSIGN-029 / E-UI-BROWSE-022 / E-UI-AXIS-NAV-040 / E-UI-MODE-041 / E-UI-SHELL-021 の改訂 ECO を起票。
