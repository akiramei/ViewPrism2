...
| BL-002 | 既存挙動/パリティ裁定 | フィルタ変更時の選択ポリシー(維持/交差/クリア)を明示裁定し画像タブを作業タブの安全側へ揃える | low〜med | **staged(ECO-097・gate①待ち・2026-07-16)** |
...
- **昇格(2026-07-16)**: `/eco-file BL-002` により **ECO-097** へ staged 起票。工程診断は
  CAD/BOM の選択寿命契約欠落。案A=可視集合との交差(推奨)/案B=全クリア/案C=維持正式化の
  gate①裁定待ち。src/tests は未変更。
